var stageModule = angular.module("kanbanboard.module.stage", [
    "kanbanboard.common.factories",
    "ui.router"
]);

stageModule.config(function config($stateProvider) {
    $stateProvider
        .state("stage", {
            url: "/stage",
            abstract: true,
        ...
        .state("stage.list", {
            url: "",
            templateUrl: "app/module/stage/stage.list.html",
            data: { pageTitle: "Workflow Stages" }
        })
        .state("stage.new", {
            url: "/new",
            templateUrl: "app/module/stage/stage.new.html",
            data: { pageTitle: "Add Workflow Stage" }
        })
        .state("stage.reset", {
            url: "/reset",
            templateUrl: "app/module/stage/stage.reset.html",
            data: { pageTitle: "Reset Workflow Stages" }
        })
        .state("stage.detail", {
            url: "/:id",
            templateUrl: "app/module/stage/stage.detail.html",
            data: { pageTitle: "Workflow Stage" }
        });
});

stageModule.service("StageService", function ($q, $timeout) {
    var service = this,
        JSONTYPE = "stage";
...
stageModule.controller("StageCtrl", function (StageService, Alerter, $state) {
...
stageModule.directive("stageTableRows", function () {
...
stageModule.directive('sortableRow', function () {
    return function (scope, element, attrs) {
