var avatarModule = angular.module("kanbanboard.module.avatar", [
    "ui.router"
]);

avatarModule.config(function config($stateProvider) {
    $stateProvider
        .state("avatar", {
            url: "/avatar",
            abstract: true,
        ...
        .state("avatar.list", {
            url: "",
            templateUrl: "app/module/avatar/avatar.list.html",
            data: { pageTitle: "Avatars" }
        })
        .state("avatar.new", {
            url: "/new",
            templateUrl: "app/module/avatar/avatar.new.html",
            data: { pageTitle: "Add Avatar" }
        })
        .state("avatar.detail", {
            url: "/:id",
            templateUrl: "app/module/avatar/avatar.detail.html",
            data: { pageTitle: "Avatar" }
        });
});

avatarModule.service("AvatarService", function (CBDocService) {
    var service = this,
        JSONTYPE = "avatar";
...
avatarModule.controller("AvatarCtrl", function (AvatarService) {
    var avatarCtrl = this;
...
avatarModule.directive("avatarTd", function () {
    return {
        restrict: "A",
        scope: {
            handles: "="
